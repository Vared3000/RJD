...
Рекомендуемый регламент: ежедневные и месячные копии сохраняются бессрочно без
автоматического удаления. Каждый комплект копируется за пределы основного
сервера. Периодически проверять восстановление на отдельной тестовой БД.
