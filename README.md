...
- [ ] Этап 12 — Печатные формы (в работе): готовы ФПУ-26, приложение 1.5,
      приложение 1.7 и личная карточка работника в Excel/PDF; остаются УПД
      и экспорты остальных отчётов
...
нормализованные строки импортированных актов и личных карточек, семантически
удаляя копии одинаковых строк из разных файлов. Реквизиты ДПО
восстанавливаются на дату окончания периода из `DpoHistory`.
