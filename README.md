...
- [ ] Этап 12 — Печатные формы (в работе): готовы ФПУ-26, приложение 1.5,
      приложение 1.7 и личная карточка работника в Excel/PDF, а также УПД
      в PDF; остаются печатные экспорты остальных отчётов
